...
<html>
<head>
<title>TMS | Itinerary List</title>
...
<div class="banner-3">
    <div class="container">
        <h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> TMS- Itinerary List</h1>
    </div>
</div>
<!--- /banner ---->
<!--- rooms ---->
    ...
    foreach($results as $result) { ?>
        <div class="rom-btm">
            ...
            <div class="col-md-6 room-midle wow fadeInUp animated" data-wow-delay=".5s">
                ...
                <p><b>State:</b> <?php echo htmlentities($result->State);?></p>
                <p><b>City:</b> <?php echo htmlentities($result->City);?></p>
            </div>
            <div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
                <h5>Rating: <?php echo htmlentities($result->Rating);?></h5>
                <a href="itinerary-details.php?id=<?php echo htmlentities($result->Id);?>" class="view">Details</a>
            </div>
